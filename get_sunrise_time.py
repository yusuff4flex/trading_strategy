...
def get_sunrise_time(start_year):
    start_month = 1
    ...
    # Nominatim API to get latitude and longitude
            ...
            start_time = (sun_rise- datetime.timedelta(hours=1)).time()
            #print(start_time)
...
year_2022_sunset = get_sunrise_time(2022)
year_2021_sunset = get_sunrise_time(2021)
